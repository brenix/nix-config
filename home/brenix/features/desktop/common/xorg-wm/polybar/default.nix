  ...
  services.polybar = {
    ...
    settings = {
      ...
      "bar/main" = {
        ...
        border-top-size = 1;
        font-0 = if config.dpi > 150 then "${config.fontProfiles.regular.family}:size=9;2" else "${config.fontProfiles.regular.family}:size=10;2";
        font-1 = if config.dpi > 150 then "Material Icons:size=8;3" else "Material Icons:size=9;3";
        font-2 = if config.dpi > 150 then "Font Awesome 6 Free Solid:size=8;2" else "Font Awesome 6 Free Solid:size=8;2";
