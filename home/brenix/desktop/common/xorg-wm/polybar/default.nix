  ...
  services.polybar = {
    ...
    settings = {
      ...
      "bar/main" = {
        ...
        border-top-size = 1;
        font-0 = if (hostname == "tank") then "${config.fontProfiles.regular.family}:size=18;2" else "${config.fontProfiles.regular.family}:size=12;2";
        font-1 = if (hostname == "tank") then ''"Material Icons:size=18;3"'' else ''"Material Icons:size=12;3"'';
        font-2 = if (hostname == "tank") then ''"JetBrainsMono Nerd Font Mono:size=18;2"'' else ''"JetBrainsMono Nerd Font Mono:size=16;2"'';
